...
def main():
    ...
    eval_g = constraint.Stacked_Constriants(eval_g_adolc_lst, index_lst)
    # eval_g_adolc = aa.Func_Adolc(eval_g, X_sample)

    eval_jac_g = constraint.Stacked_Constriants_Jacobian(eval_g_adolc_lst   ,
                                                         eval_jac_adolc_lst,
                                                         index_lst)
    ...
    nlp = pyipopt.create(nvar, x_L, x_U, ncon, g_L, g_U, nnzj, 0, eval_f_adolc ,
                        # eval_grad_f_adolc, eval_g, eval_jac_g)
                        eval_grad_f_adolc, eval_g, eval_jac_g)
